<div class="modal-header no-padding">
    <div class="table-header">
        Thêm mới - Cập nhật danh mục đồ dùng
    </div>
</div>
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        placeholder="Tiêu đề danh mục, ví dụ: Đồ dùng dạy học môn Vật lý" style="width:100%"
...
<div class="modal-footer">
    ...
    <button class="btn btn-sm btn-primary pull-right" onclick="save_utensils()">
