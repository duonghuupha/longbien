    ...
    <div class="row">
        <div class="post">
            ...
            <div class="post_middle">
                <span>đề nghị luân chuyển trang thiết bị</span>
            ...
            <div class="post_main">
                ...
                <span>Qua rà soát, kiểm tra trang thiết bị tại <b><?php echo $item[0]['physical_from'].'</b> và <b>'.$item[0]['physical_to'] ?></b></span>
                <span>Đề nghị luân chuyển trang thiết bị từ: <b><?php echo $item[0]['physical_from'] ?></b> đến <b><?php echo $item[0]['physical_to'] ?></b></span>
            </div>
            ...
            <div class="post_footer">
                ...
                <div class="post_left">
                    ...
                    ?>
                    <span style="font-weight:normal"><i>(Từ chối)</i></span>
                    <?php
                    }else{
                    ?>
                    <span style="font-weight:normal"><i>(Chờ duyệt)</i></span>
                    <?php
                    }
                    ?>
                </div>
...
<div class="modal-footer">
    ...
    ?>
    <button class="btn btn-sm btn-success pull-right" onclick="app_change(<?php echo $_REQUEST['id'] ?>)">
