...
<table 
    ...
    <thead>
        <tr role="row">
            ...
            <th class="text-center" style="width:80px">Mã luân chuyển</th>
...
<div class="row mini">
    ...
    <div class="col-xs-12 col-sm-6">
        ...
        if($jsonObj['total'] > $perpage){
            ...
            $createlink = $convert->createLinks($jsonObj['total'], $perpage, $pagination['number'], 'view_page_change_device', 1);
        ?>
