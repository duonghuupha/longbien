                ...
                <div class="row">
                    <form id="fm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-4">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="form-field-username">Ngày đến</label>
                                    <div class="input-group">
                                        <input class="form-control date-picker" id="date_in" type="text" 
                                        name="date_in" required="" data-date-format="dd-mm-yyyy" readonly=""/>
