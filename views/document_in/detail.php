    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    <label for="form-field-username">
                        <b>Số đến:</b> <?php echo $jsonObj[0]['number_in'] ?>
                    </label>
                </div>
                <div class="form-group">
                    <label for="form-field-username">
                        <b>Ngày đến:</b> <?php echo date("d-m-Y", strtotime($jsonObj[0]['date_in'])) ?>
                    </label>
                </div>
                <div class="form-group">
                    <label for="form-field-username">
        ...
        <div class="col-xs-8" style="border-left:1px solid #000">
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <label for="form-field-username">
                        <b>Tệp văn bản:</b> 
                        <a href="<?php echo URL.'/public/document_in/'.$jsonObj[0]['cate_id'].'/'.$jsonObj[0]['file'] ?>"
