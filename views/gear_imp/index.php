        ...
        <div class="modal-content">
            <div class="modal-header no-padding">
                <div class="table-header">
                    Thêm mới - Cập nhật thông tin tiếp nhận đồ dùng
                </div>
            </div>
                ...
                <div class="row">
                    <form id="fm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-4" style="height:505px">
                            <div class="col-xs-12 col-sm-12">   
                                <input type="text" placeholder="Tìm kiếm ..." class="form-control" id="nav-search-gear"
                                onkeyup="search_gear()" style="width:100%"/>
                            </div>
                            <div class="col-xs-12">
...
<script src="<?php echo URL.'/public/' ?>scripts/gear/imp.js"></script>