...
<table 
    ...
    <thead>
        <tr role="row">
            ...
            <th class="text-left hidden-480">Họ tên nhân sự</th>
            <th class="text-center hidden-480">Đăng nhập lần cuối</th>
            <th class="text-center hidden-480">Thông tin đăng nhập</th>
    ...
    <tbody>
        ...
        <tr role="row" class="<?php echo $class ?>">
            ...
            <td class="text-center hidden-480"><?php echo $row['fullname'] ?></td>
            <td class="text-center hidden-480"><?php echo $row['last_login'] ?></td>
            <td class="text-center hidden-480"><?php echo $row['info_login'] ?></td>
