<div class="modal-header no-padding">
    <div class="table-header">
        Thêm mới - Cập nhật Danh mục trang thiết bị
    </div>
</div>
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        placeholder="Tiêu đề danh mục, ví dụ: Máy chiếu, máy tính" style="width:100%"
...
<div class="modal-footer">
    ...
    <button class="btn btn-sm btn-primary pull-right" onclick="save_equipment()">
