...
<table 
    ...
    <thead>
        <tr role="row">
            ...
            <th class="text-center" style="width:140px" rowspan="2">Ngày lên lớp</th>
    ...
    <tbody>
        ...
        <tr role="row" class="<?php echo $class ?>">
            ...
            <td class="text-center"><?php echo $row['yearfrom'] ?></td>
            <td class="text-center"><?php echo $row['departmentfrom'] ?></td>
            <td class="text-center"><?php echo $row['yearto'] ?></td>
            <td class="text-center"><?php echo $row['departmentto'] ?></td>
        </tr>
        <?php
        }
        ?>
