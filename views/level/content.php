        ...
        <tr role="row" class="<?php echo $class ?>">
            ...
            <td class="text-center">
                <div class="hidden-sm hidden-xs action-buttons">
                    <a class="green" href="javascript:void(0)" onclick="edit_level(<?php echo $row['id'] ?>)">
                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                    </a>
                    <a class="red" href="javascript:void(0)" onclick="del_level(<?php echo $row['id'] ?>)">
...
<div class="row mini">
    ...
    <div class="col-xs-12 col-sm-6">
        ...
        if($jsonObj['total'] > $perpage){
            ...
            $createlink = $convert->createLinks($jsonObj['total'], $perpage, $pagination['number'], 'view_page_level', 1);
        ?>
