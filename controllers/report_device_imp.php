<?php
class Report_device_imp extends Controller{
    ...
    function index(){
        ...
        $this->view->render('report_device_imp/index');
    ...
    function content(){
        ...
        $this->view->render('report_device_imp/content');
    }
    ...
    function export_xlsx(){
		...
		$sheet->setCellValue ( 'A3', 'BÁO CÁO QUÁ TRÌNH NHẬP TRANG THIẾT BỊ');
		...
		$colIndex = $helpExport->setValueForSheet ( $sheet, $colIndex . $rowIndex, 'Nguồn trang thiết bị', $colIndex );
        $colIndex = $helpExport->setValueForSheet ( $sheet, $colIndex . $rowIndex, 'Tổng đầu thiết bị', $colIndex );
        $colIndex = $helpExport->setValueForSheet ( $sheet, $colIndex . $rowIndex, 'Tổng số lượng thiết bị', $colIndex );
        ...
        foreach($jsonObj as $rows){
            ...
            $colIndex = $helpExport->setValueForSheet ( $sheet, $colIndex . $rowIndex, $rows['total_device'], $colIndex );
