...
class Report_book_return extends Controller{
    ...
    function export_xlsx(){ 
		...
		$sheet->setCellValue ( 'A3', 'BÁO CÁO THU HỒI - KHÔI PHỤC SÁCH');
        ...
        foreach($jsonObj as $rows){
            ...
            $colIndex = $helpExport->setValueForSheet ( $sheet, $colIndex . $rowIndex, $rows['title'].'-'.$rows['sub_book'], $colIndex );
		...
		header ( 'Content-Disposition: attachment;filename="Bao_cao_thu_hoi_khoi_phuc_sach_thu_vien.xlsx"' );
