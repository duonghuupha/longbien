...
class User_Excel {
	 ...
	 * text-align:	Center
	 */
	function setStyle_10_TNR_B_R($sheet, $colRowStart, $colRowStop) {
		$_sheet = $sheet;
		$_sheet->getStyle ( $colRowStart . ':' . $colRowStop )->applyFromArray ( array (
				'font' => array (
						'name' => 'Times New Roman',
	 ...
	 * text-align:	Center
	 */
	function setStyle_8_TNR_N_C($sheet, $colRowStart, $colRowStop) {
		$_sheet = $sheet;
		$_sheet->getStyle ( $colRowStart . ':' . $colRowStop )->applyFromArray ( array (
				'font' => array (
						'name' => 'Times New Roman',
    ...
    function setStyle_Align_Right_Bold($sheet, $colRowStart, $colRowStop) {
		$_sheet = $sheet;
		$_sheet->getStyle ( $colRowStart . ':' . $colRowStop )->applyFromArray ( array (
                'font' => array (
						'name' => 'Times New Roman',
	...
	function setStyle_Align_Left_Italic($sheet, $colRowStart, $colRowStop) {
		$_sheet = $sheet;
		$_sheet->getStyle ( $colRowStart . ':' . $colRowStop )->applyFromArray ( array (
                'font' => array (
						'name' => 'Times New Roman',
