...
$(function(){
    $('#list_loan').load(baseUrl + '/report_device_loan/content');
});
...
function search(){
    ...
    if(status.length == 0 && status1.length == 0){
        $('#list_loan').load(baseUrl + '/report_device_loan/content?page=1&fromloan='+fromdateloan+'&toloan='+todateloan
...
function view_page_loan(pages){
    page = pages;
    $('#list_loan').load(baseUrl + '/report_device_loan/content?page='+page+'&fromloan='+fromdateloan+'&toloan='+todateloan
    +'&fromreturn='+fromdatereturn+'$toreturn='+todatereturn+'&fullname='+fullname+'&title='+title);
}

function export_xlsx(){
    window.open(baseUrl + '/report_device_loan/export_xlsx?fromloan='+fromdateloan+'&toloan='+todateloan
    +'&fromreturn='+fromdatereturn+'$toreturn='+todatereturn+'&fullname='+fullname+'&title='+title)
}

function export_detail(){
    window.open(baseUrl + '/report_device_loan/export_detail?fromloan='+fromdateloan+'&toloan='+todateloan
    +'&fromreturn='+fromdatereturn+'$toreturn='+todatereturn+'&fullname='+fullname+'&title='+title)
}
/////////////////////////////////////////////////////////////////////////////////////////
